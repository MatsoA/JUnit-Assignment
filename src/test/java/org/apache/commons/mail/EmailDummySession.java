...
public class EmailDummySession extends EmailConcrete {
	...
	public EmailDummySession(String hostName, String sender, String recipient) throws EmailException, MessagingException {
		
		MimeMultipart multipart = new MimeMultipart();
		MimeBodyPart bodyMessagePart = new MimeBodyPart();
		bodyMessagePart.setContent("email body", this.charset);
		multipart.addBodyPart(bodyMessagePart);
		Session aSession = Session.getDefaultInstance(System.getProperties());
