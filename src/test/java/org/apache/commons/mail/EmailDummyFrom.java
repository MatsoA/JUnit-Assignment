...
public class EmailDummyFrom extends EmailConcrete {
	...
	public EmailDummyFrom() throws EmailException, MessagingException {
		

		this.fromAddress = createInternetAddress("ab@bc.com", null, this.charset);
